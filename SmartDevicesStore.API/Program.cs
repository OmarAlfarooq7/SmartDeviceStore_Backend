...
using (var scope = app.Services.CreateScope())
{
    ...
    // ✅ InMemoryDatabase الطريقة البرمجية لمسح البيانات لضمان نظافتها مع 
    ...
    // فحص إذا كانت الأصناف فارغة (ستكون فارغة دائماً هنا بسبب المسح أعلاه أو لأنها في الذاكرة)
    if (!context.Categories.Any())
    {
